...
def test_get_current_user():
    ...
    fake_token_data = TokenData(sub="123", role="user")

    # Ajuste: faça o mock retornar um dict
    with patch("api_certify.dependencies.JWTManager.verify_and_decode_jwt", return_value=fake_token_data.dict()):
