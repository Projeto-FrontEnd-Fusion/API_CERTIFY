...
DESC_REQ_CERTIFICATE_FULLNAME = 'Nome completo do usuário para identificação. Deve conter nome e sobrenome'
DESC_REQ_CERTIFICATE_EMAIL = 'Endereço de email válido utilizado para login e comunicação'
...
DESC_CERTIFICATE_ID = 'Identificador único do certificado no banco de dados (MongoDB ObjectId)'
DESC_CERTIFICATE_USER_ID = 'Identificador único do usuário que está emitindo o certificado'
DESC_CERTIFICATE_ACCESS_KEY = 'Token de autenticação do certificado'
DESC_CERTIFICATE_STATUS = 'Status do certificado ("pending" | "available" | "expired")'
...
DESC_CERTIFICATE_PARTICIPANT_EMAIL = 'Email do participante que emitiu o certificado'
DESC_CERTIFICATE_INSTITUTION_NAME = 'Nome da instituição que ministrou o curso'
DESC_CERTIFICATE_EVENT_ID = 'Identificador único do evento no banco de dados (MongoDB ObjectId)'
...
class CreateCertificate(BaseModel):
    ...
    # TODO: Verificar como será gerado o certificado
    event_id: str = Field()
